...
const Projects = () => {
  ...
  const cards = [
    ...
    {
      title: "Flagship-FaceOff",
      image: FlagshipFaceOff,
      desc: "Flagship-phone-shopping is a sleek React app designed for browsing and applying various visual filters to images. It offers real-time previews, mobile-friendly design, and an intuitive interface that enhances user creativity.",
      tags: ["React", "TailwindCSS"],
      live: "http://gaudy-camera.surge.sh",
      code: "https://github.com/Rakib-Hasan1/Flagship-phone-shopping/tree/main",
    },
    {
      title: "Dragon News",
      image: dragon_news,
      desc: "Dragon News is a front-end web application built with React that delivers real-time news articles across multiple categories. It offers a smooth and engaging user experience on desktop & laptop, complete with Firebase Authentication for secure and personalized access.",
      tags: ["React", "TailwindCSS", "Firebase"],
      live: "https://the-dragon-news-6136e.web.app",
      code: "https://github.com/Rakib-Hasan1/dragon-news-authentication",
    },
  ];
